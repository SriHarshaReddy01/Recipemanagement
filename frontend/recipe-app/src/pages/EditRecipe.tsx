...
import type { Ingredient, Category, Recipe } from '../types';
...
export default function EditRecipe() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (user && recipeData.ownerUserId !== user.userId) {
      ...
      setIngredients(recipeData.recipeIngredients.map(ri => ({
        ingredientId: ri.ingredientId,
        quantity: ri.quantity
      })));
      setSelectedCategories(recipeData.recipeCategories.map(rc => rc.categoryId));
      setSteps(recipeData.steps.sort((a, b) => a.stepNumber - b.stepNumber).map(s => s.description));
